...
public class MTR implements IPacket {
	...
	public static void init(
		...
		mtr.mappings.NetworkUtilities.registerServerS2CTypes(dev.architectury.platform.Platform.getEnvironment(),
			...
			PACKET_CHUNK_S2C,
			PACKET_OPEN_DASHBOARD_SCREEN,
			PACKET_OPEN_PIDS_CONFIG_SCREEN,
			PACKET_OPEN_ARRIVAL_PROJECTOR_CONFIG_SCREEN,
			PACKET_OPEN_RAILWAY_SIGN_SCREEN,
			PACKET_OPEN_TICKET_MACHINE_SCREEN,
			PACKET_OPEN_TRAIN_SENSOR_SCREEN,
			PACKET_OPEN_RESOURCE_PACK_CREATOR_SCREEN,
			PACKET_ANNOUNCE,
			PACKET_GENERATE_PATH,
			PACKET_CREATE_RAIL,
			PACKET_CREATE_SIGNAL,
			PACKET_REMOVE_NODE,
			PACKET_REMOVE_RAIL,
			PACKET_REMOVE_SIGNALS,
			PACKET_REMOVE_LIFT_FLOOR_TRACK,
			PACKET_UPDATE_STATION,
			PACKET_UPDATE_PLATFORM,
			PACKET_UPDATE_SIDING,
			PACKET_UPDATE_ROUTE,
			PACKET_UPDATE_DEPOT,
			...
			PACKET_UPDATE_LIFT,
			PACKET_WRITE_RAILS,
			PACKET_UPDATE_TRAINS,
			PACKET_UPDATE_LIFTS,
			PACKET_DELETE_TRAINS,
			PACKET_DELETE_LIFTS,
			PACKET_UPDATE_TRAIN_PASSENGERS,
			PACKET_UPDATE_LIFT_PASSENGERS,
			PACKET_UPDATE_TRAIN_PASSENGER_POSITION,
			PACKET_UPDATE_LIFT_PASSENGER_POSITION,
			PACKET_UPDATE_RAIL_ACTIONS,
			PACKET_UPDATE_SCHEDULE,
			PACKET_OPEN_LIFT_TRACK_FLOOR_SCREEN,
			PACKET_OPEN_LIFT_CUSTOMIZATION_SCREEN);
