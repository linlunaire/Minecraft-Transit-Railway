			...
			for (int j = 0; j < maxArrivals; j++) {
				...
				for (int k = 0; k < linesPerArrival; k++) {
					...
					if (useCustomMessage) {
						...
						drawText(textRenderer, destinationString, matrices, vertexConsumers, light, textColor);
					} else {
						// Render arrival
						...
						if (renderType.showPlatformNumber && ((arrivalLine == 0 && renderSingle) || renderClassic)) {
							...
							drawText(textRenderer, platformNameComponent, matrices, vertexConsumers, light, seconds > 0 ? textColor : firstTrainColor);
						...
						if (renderSingle && arrivalLine == 3) {
							...
							drawText(textRenderer, callingAtText, matrices, vertexConsumers, light, seconds > 0 ? textColor : firstTrainColor);
							matrixStackHolder.pop();
						}
						...
						if (renderSingle && arrivalLine >= 4 && arrivalLine < 14) {
							...
							drawText(textRenderer, callingAtStationText, matrices, vertexConsumers, light, seconds > 0 ? textColor : firstTrainColor);
							matrixStackHolder.pop();
						}
						...
						if (showCarLength) {
							...
							drawText(textRenderer, carText, matrices, vertexConsumers, light, CAR_TEXT_COLOR);
							matrixStackHolder.pop();
						}
						...
						drawText(textRenderer, destinationString, matrices, vertexConsumers, light, seconds > 0 ? textColor : firstTrainColor);
						matrixStackHolder.pop();
						...
						if (arrivalText != null) {
							...
							drawText(textRenderer, arrivalText, matrices, vertexConsumers, light, textColor);
							matrixStackHolder.pop();
						}
					}
					matrixStackHolder.pop();
