...
public class MoreRenderLayers extends RenderLayerMapper {
	...
	private static final Map<Identifier, RenderType> LIGHT_CACHE = new HashMap<>();
	private static final Map<Identifier, RenderType> LIGHT_TRANSLUCENT_CACHE = new HashMap<>();
